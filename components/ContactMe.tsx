    ...
    <div className="h-screen flex relative flex-col text-center md:text-left md:flex-row max-w-7xl px-10 justify-evenly mx-auto items-center">
      ...
      <div className="flex flex-col space-y-10 mt-36">
        ...
        <form
          ...
          className="flex flex-col space-y-2 w-[370px] md:w-fit mx-auto"
        >
          <div className="flex space-x-2 md:w-fit">
            <input
              {...register("name")}
              placeholder="Name"
          ...
          <textarea
            ...
            className="contactInput"
          />
          <button className="bg-[#F7AB0A] py-5 px-10 rounded-md text-black font-bold text-g">
            Submit
          </button>
        </form>
      </div>
